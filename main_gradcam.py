...
parser.add_argument('--model-path', type=str, default="mydetect/weights/aug.pt", help='Path to the model')
parser.add_argument('--img-path', type=str, default='test', help='input image path')
